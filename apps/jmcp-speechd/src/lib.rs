...
impl SpeechConfig {
    pub fn new(role: impl Into<String>, transcript: impl Into<String>, fail_closed: bool) -> Self {
        Self {
            role: role.into(),
...
pub fn router(config: SpeechConfig) -> Router {
...
pub async fn serve(bind: SocketAddr, config: SpeechConfig) -> Result<()> {
